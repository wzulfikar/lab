...
s_pin NUMBER(4),
s_image BLOB, 
CONSTRAINT stafs_s_id_pk PRIMARY KEY(s_id),
CONSTRAINT stafs_loc_id_fk FOREIGN KEY (loc_id) REFERENCES location(loc_id));
...
CONSTRAINT student_s_id_pk PRIMARY KEY (student_id),
CONSTRAINT student_s_id_fk FOREIGN KEY (s_id) REFERENCES staff(s_id));
...
CONSTRAINT course_section_fid_fk FOREIGN KEY (s_id) REFERENCES staff(s_id));

CREATE TABLE ENROLLMENT
(student_id VARCHAR2(6),
c_sec_id NUMBER(6),
grade CHAR(1),
CONSTRAINT enrollment_pk PRIMARY KEY (student_id, c_sec_id),
CONSTRAINT enrollment_sid_fk FOREIGN KEY (student_id) REFERENCES student(student_id),
...
INSERT INTO staff VALUES
(5, 'Sealy', 'James', 'L', 13, '4079817153', 'Associate', 2, 6089, EMPTY_BLOB());
